          ...
          <div className="flex-1 min-w-0 space-y-1">
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <Badge variant={getBadgeVariant()} className="flex-shrink-0 hidden md:flex">
    ...
    try {
      ...
      querySnapshot.forEach((doc) => {
        ...
        if (notification.type === "weekly_spending") {
          ...
          if (
            !weeklyNotifications.has(weekKey) ||
      ...
      const allNotifications = [...Array.from(weeklyNotifications.values()), ...otherNotifications].sort(
    ...
    <div className="container mx-auto max-w-4xl py-8 px-4">
      <Card className="shadow-lg">
        <CardHeader className="space-y-1">
          ...
          <CardDescription>Stay updated with your expense tracking activities</CardDescription>
        </CardHeader>
        <CardContent>
